package com.example.kiersey.puzzlebuttons;
...
public class FullscreenActivity extends AppCompatActivity {
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.example.kiersey.puzzlebuttons/http/host/path")
        );
    ...
    private void checkWin() {
        ...
        if(tb1.isChecked() && tb2.isChecked() && tb3.isChecked() && tb4.isChecked() && tb5.isChecked()
                && tb6.isChecked() && tb7.isChecked() && tb8.isChecked() && tb9.isChecked()) {
